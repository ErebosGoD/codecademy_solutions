class Menu:
  ...
  #will be executed at the moment of instantiation of the class, setting the given parameters accordingly. Does NOT need to be invoked by the user.
  ...
  #returns a string representation of the instance of the class which can be printed to the console. Does NOT need to be invoked by the user.
...
# only 4 arguments need to be given, because the "self" argument listed in the "__init__()" method revers to the object itself and doesn't need specification
